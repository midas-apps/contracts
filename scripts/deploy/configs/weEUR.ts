...
export const weEURDeploymentConfig: DeploymentConfig = {
  genericConfigs: {
    customAggregator: {
      // maxAnswerDeviation: parseUnits('0.2', 8), // scroll
      maxAnswerDeviation: parseUnits('0.25', 8), //optimism
  ...
  networkConfigs: {
    ...
    [chainIds.optimism]: {
      dv: {
        ...
        feeReceiver: '0x5115C8927be378544377D0705f227818F3a46720',
        tokensReceiver: '0x0D3f9D9Bf43A8D804ac55bA52a341494A5d28381',
        instantDailyLimit: constants.MaxUint256,
        instantFee: parseUnits('0', 2),
        variationTolerance: parseUnits('0.25', 2),
        minMTokenAmountForFirstDeposit: parseUnits('0', 18),
      ...
      rvSwapper: {
        type: 'SWAPPER',
        feeReceiver: '0xE433DB2Ce2C30B44Cf521Fe51577B10cfDFb9c4e',
        tokensReceiver: '0x0D3f9D9Bf43A8D804ac55bA52a341494A5d28381',
        requestRedeemer: '0xb077Da537055b61621cDD9fdD525089E0199CF39',
        instantDailyLimit: constants.MaxUint256,
        instantFee: parseUnits('0.3', 2),
        variationTolerance: parseUnits('0.25', 2),
        liquidityProvider: 'dummy',
