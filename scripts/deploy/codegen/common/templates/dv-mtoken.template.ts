...
export const getDvMTokenContractFromTemplate = async (mToken: MTokenName) => {
  ...
  return {
     ...
     * @notice Smart contract that handles ${contractNames.token} minting with mToken auto-invest
