...
import { M_EDGE_DATA_FEED_CONTRACT_NAME } from '../../../config';
...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  const deployment = await hre.upgrades.deployProxy(
    await hre.ethers.getContractFactory(M_EDGE_DATA_FEED_CONTRACT_NAME, owner),
    [
  ...
  await logDeployProxy(hre, M_EDGE_DATA_FEED_CONTRACT_NAME, deployment.address);
