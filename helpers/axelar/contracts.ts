export const axelarItsAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bytes', name: 'minter', type: 'bytes' },
      {
        indexed: false,
        internalType: 'string',
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'bytes32', name: 'trustedAddressHash_', type: 'bytes32' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
export const axelarItsFactoryAbi = [
  ...
  { inputs: [], name: 'InvalidOwnerAddress', type: 'error' },
  {
    inputs: [
      { internalType: 'bytes32', name: 'tokenId', type: 'bytes32' },
      { internalType: 'bytes32', name: 'expectedTokenId', type: 'bytes32' },
    ],
    name: 'InvalidTokenId',
    type: 'error',
  },
  ...
  },
  {
    ...
    outputs: [{ internalType: 'bytes32', name: 'deploySalt', type: 'bytes32' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
